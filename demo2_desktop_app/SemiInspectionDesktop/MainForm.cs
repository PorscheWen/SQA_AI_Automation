...
namespace SemiInspectionDesktop
{
    ...
    {
        const string DefaultRecipeDataPath =
            @"C:\Users\BaoGo\Documents\ClaudeCode_Project\SQA_AI_Automation\demo2_desktop_app\Recipe_data";
        ...
        {
            if (Directory.Exists(DefaultRecipeDataPath))
                return DefaultRecipeDataPath;
