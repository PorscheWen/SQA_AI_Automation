    ...
    <div class="results-header">
      ...
      <div>
        ...
        <div class="report-links">
          ${links.html ? `<a href="/reports/TestReport.html" target="_blank" rel="noopener">ExtentReports HTML</a>` : ""}
          ${links.summaryHtml ? `<a href="/reports/summary_report.html" target="_blank" rel="noopener">Summary Report</a>` : ""}
          ${links.junit ? `<a href="/reports/junit-results.xml" target="_blank" rel="noopener">JUnit XML</a>` : ""}
        </div>
